...
";
$where_clauses = ["fi.jenis_form = 'event'"];

// Filter berdasarkan user_id jika level adalah 2 (Admin)
...
if ($active_form_id > 0) {
    ...
    if ($form_detail && isset($_SESSION['user_level']) && $_SESSION['user_level'] == 2) {
        if ($form_detail['user_id'] != $_SESSION['user_id']) {
            ...
            header('Location: ?page=oprec-event&error=unauthorized_access');
            exit;
        }
    }
...
$submissionCount = 0;
// --- PERUBAHAN: Hitung submission hanya untuk form 'event' ---
if ($active_form_id > 0) {
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-calendar-plus"></i> Form Builder (Event)</h1>
        <a href="?page=oprec-event&create=1" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            <i class="fas fa-plus fa-sm text-white-50"></i> Buat Form Event Baru
        </a>
    </div>
            ...
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Formulir Event</div>
        ...
        <div class="col-xl-4 col-lg-5">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Daftar Formulir Event</h6>
                    <a href="?page=oprec-event&create=1" class="btn btn-primary btn-sm btn-circle" title="Buat Form Baru">
                ...
                <div class="card-body" style="max-height: 500px; overflow-y: auto;">
                    <?php if (empty($all_forms)): ?>
                        <div class="text-center text-muted py-5">
                            ...
                            <p class="mb-2">Belum ada formulir event</p>
                            <a href="?page=oprec-event&create=1" class="btn btn-sm btn-primary">
                                <i class="fas fa-plus"></i> Buat Formulir Event
                            </a>
                        </div>
                    <?php else: ?>
                                ...
                                <div class="list-group-item px-0 <?= $active_form_id == $form['id'] ? 'bg-light' : '' ?>">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="flex-grow-1">
                                            <a href="?page=oprec-event&form_id=<?= $form['id'] ?>" class="font-weight-bold text-gray-800">
                                        ...
                                        <div class="ml-2">
                                            ...
                                            <a href="?page=oprec-event&form_id=<?= $form['id'] ?>" class="btn btn-info btn-sm btn-circle" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="?page=oprec-event&view_submissions=<?= $form['id'] ?>" class="btn btn-warning btn-sm btn-circle" title="Lihat Submissions">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                        <h6 class="m-0 font-weight-bold text-primary">
                            <?= $active_form_id > 0 && $form_detail ? 'Edit Formulir Event' : 'Buat Formulir Event Baru' ?>
                        </h6>
                        <a href="?page=oprec-event" class="btn btn-sm btn-secondary btn-circle" title="Tutup">
                    ...
                    <div class="card-body">
                        <form method="POST" action="../../../Function/FormFunction.php" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="jenis_form" value="event">
            ...
            <?php else: ?>
                ...
                <div class="card shadow mb-4">
                    <div class="card-body text-center py-5">
                        ...
                        <a href="?page=oprec-event&create=1" class="btn btn-primary">
