...
if ($user_id) {
    ...
    if ($user_data) {
        ...
        $program_studi = htmlspecialchars($user_data['program_studi'], ENT_QUOTES, 'UTF-8');
        $angkatan = htmlspecialchars($user_data['angkatan'], ENT_QUOTES, 'UTF-8');
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img src="<?php echo $logo_ormawa; ?>" class="img-profile rounded-circle mb-2" alt="Profil/Logo Ormawa"> <!-- Path gambar profil tetap -->
            </a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        <th>Ormawa:</th>
                                        <td><?php echo $nama_ormawa_detail; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Level:</th>
...
<!-- Modal Logout (tetap seperti sebelumnya) -->
