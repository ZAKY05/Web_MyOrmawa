...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('btnSimpanSesi')?.addEventListener('click', async function () {
            ...
            // ✅ Gunakan fetch untuk submit form
            try {
                const formData = new FormData(form);

                const response = await fetch('../../../Function/AbsensiFunction.php', {
                    method: 'POST',
                    body: formData
                });
                ...
                if (data.success) {
                    ...
                    // ✅ Redirect ke halaman FiturAbsensi atau reload
                    window.location.href = 'Index.php?page=absensi'; // Sesuaikan dengan path Anda
                    // ATAU gunakan: window.location.reload(); // untuk reload halaman saat ini
                } else {
                    Swal.fire({
                        icon: 'error',
                        title: 'Gagal',
