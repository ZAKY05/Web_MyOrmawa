                                ...
                                <tr data-ormawa-id="<?= (int) $s['ormawa_id']; ?>">
                                    ...
                                    <td class="text-nowrap">
                                        ...
                                        <button class="btn btn-sm btn-success me-1"
                                            onclick="exportToExcel(<?= (int) $s['id']; ?>)"
...
<script>
    ...
    function exportToExcel(kehadiranId) {
        ...
        link.href = '../../../Function/ExportAbsensiFunction.php?kehadiran_id=' + kehadiranId; // Ganti nama file
        link.target = '_blank'; // Opsional, bisa dihapus untuk langsung download
