...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <button type="button" class="btn btn-primary btn-sm" 
                data-bs-toggle="modal" data-bs-target="#buatSesiModal">
            ...
            <select class="form-select" id="filterOrmawa">
                ...
                <?php foreach ($allOrmawas as $o): ?>
                    <option value="<?= (int)$o['id']; ?>" 
                            <?= $selected_ormawa_id == $o['id'] ? 'selected' : ''; ?>>
        ...
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">
                ...
                <?php if ($user_level === 1 && $selected_ormawa_id > 0): ?>
                    <small class="text-muted">— <?= htmlspecialchars(array_column($allOrmawas, 'nama_ormawa', 'id')[$selected_ormawa_id] ?? 'ORMAWA'); ?></small>
                <?php endif; ?>
            </h6>
...
function selesaiSesi(id) {
    if (!confirm("Akhiri sesi ini? Peserta tidak bisa absen lagi.")) return;
